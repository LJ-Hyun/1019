  ...
  for(var i =0; i < arrMissiles.length; i++){
    ...
    if(arrMissiles[i].x < 0 || arrMissiles[i].x > 800 || arrMissiles[i].y < 0 || arrMissiles[i].y > 600)
    {
      ...
      switch(MissileType)
      {
        case 1: //왼쪽 총알
          arrMissiles[i].x = 0;
          arrMissiles[i].y = RandomNext(600);
          arrMissiles[i].go_x = RandomNext(2);
          arrMissiles[i].go_y = -2 + RandomNext(4);
          break;
        case 2: //오른쪽 총알
          arrMissiles[i].x = 800;
          arrMissiles[i].y = RandomNext(600);
          ...
          break;
        case 3: //위쪽 총알
          arrMissiles[i].x = RandomNext(600);
          arrMissiles[i].y = 0;
          arrMissiles[i].go_x = -2 + RandomNext(4);
          arrMissiles[i].go_y = RandomNext(2);
          break;
        case 4: //아래쪽 총알
          arrMissiles[i].x = RandomNext(600);
          arrMissiles[i].y = 600;
